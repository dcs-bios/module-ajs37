...
-- elements["PNT_POOP"] = default_axis_limited("Radar Night Filter", 5, 3500, -666, 1, 0.1, true, true)
-- elements["PNT_400"] = default_1_position_tumb("Missile Select Button (IR-RB FRAMSTEGN)", 2, 3500, -666)
-- elements["PNT_CMEASURES"] = multiposition_switch_limited("Countermeasure Dispense", 28, 3505, -666, 3, 1, false, -1.0)
